                ...
                function(e, t, r) {
                    ...
                    t.exports = function(d, e, f) {
                        d = b(d),
                            (f = f || {}).summary_text =
                            f.summary_text ||
                            'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>",
                            f.cache = 1e3 * (f.cache || 86400), !1 === f.global_stats && (d.style.minHeight = "175px");
                        var r = {
